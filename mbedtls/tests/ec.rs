...
fn sign_verify_rfc6979_sig() {
    ...
    let mut p256 = Pk::from_private_key(RFC6979_P256_KEY.as_bytes(), None, &mut test_rng()).unwrap();
    ...
    let mut p521 = Pk::from_private_key(RFC6979_P521_KEY.as_bytes(), None, &mut test_rng()).unwrap();
